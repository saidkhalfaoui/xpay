package com.xpay.sepadd.iso20022.sepa.sdd;

import com.xpay.sepadd.dto.mapper.CreditorInfoJsonObjectMapper;
import com.xpay.sepadd.dto.CreditorInfo;
import com.xpay.sepadd.dto.DirectDebitRequestData;
import com.xpay.sepadd.dto.Mandateinformation;
import com.xpay.sepadd.iso20022.sepa.BasePainFile;
import com.xpay.sepadd.iso20022.sepa.IBANUtils;
...
import static com.xpay.sepadd.iso20022.sepa.sdd.Utils.*;
...
public class DirectDebitPainFile extends BasePainFile {
    ...
    public PaymentInstruction paymentInstruction(
        ...
        List<String> addressLines = com.xpay.sepadd.iso20022.sepa.Utils.toAdressLines(creditorInfo.getAccountInfo().getAddress());
