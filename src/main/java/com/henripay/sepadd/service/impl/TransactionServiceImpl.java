...
public class TransactionServiceImpl implements TransactionService  {
  ...
  private TransactionDAO dao;
    ...
    @Override
    public List<DirectDebitRequestData> getReadyToProcessDirectDebitTransactions(int batchSize) {return dao.getReadyToProcessDirectDebitTransactions(batchSize);
    }

    public List<CreditTransferRequestData> getReadyToProcessCreditTransferTransactions(int batchSize) {return dao.getReadyToProcessCreditTransferransactions(batchSize);
    }
